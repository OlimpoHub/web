        ...
        <main className={styles.container}>
            <div className={styles.card} role="main">
                ...
                {!token && (
                    <div>
                        <p>
                            Este es el fallback web para restablecer contraseñas. Si tienes un
                            token, pégalo abajo y pulsa "Usar token".
                        </p>
                        ...
                        <div className={styles.actions}>
                            <button
                                className={`${styles.cta} ${styles.ctaFull}`}
                                onClick={onPasteTokenUse}
                            >
                                Usar token
                            </button>
                        </div>
